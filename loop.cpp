...
void GetStateSerial()
{
  sprintf_P(my_tx_buffer,PSTR("%lu\tT=\t%3u\t%3u\t%3u\tGlv=%4u\tI=%3u\tS=%3u\t%4uW\tOFF=%1i\t%3imm\t%3uV"),Seconds,temps[TEMP_KUB],temps[TEMP_DEFL],temps[TEMP_TSA],U_GLV,IspReg,StateMachine,UstPower,(int) flAllOff,U_MPX5010,MaxVoltsOut);
