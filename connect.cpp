...
#include "declarations.h"
  ...
  void SendWiFi8266()
  {
    ...
    void GetState()
    {
      ...
      tic1=Seconds % 3600;
      minute=tic1 / 60;
      sprintf_P(my_tx_buffer,PSTR("%02u:%02u I=%3u S=%3u T=%3u,%3u,%3u V=%4u,%4u OFF=%1i,%4uW,U=%3u,%3imm"),hour,minute,IspReg, StateMachine,temps[TEMP_KUB],temps[TEMP_DEFL],temps[TEMP_TSA],U_VODA,U_UROVEN, (int) flAllOff,UstPower,MaxVoltsOut,U_MPX5010);
